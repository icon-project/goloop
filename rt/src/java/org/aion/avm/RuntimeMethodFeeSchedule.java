...
public class RuntimeMethodFeeSchedule {
    ...
    public static final int RT_HASH_METHOD_FEE_LEVEL_1 = 2000;

    public static final int RT_METHOD_FEE_FACTOR = 5;
    ...
    public static final int ShortArray2D_avm_clone = RT_METHOD_FEE_LEVEL_3; // totalCost - 762; // byte code cost - 362; invoked methods cost - 400;
    public static final int ShortArray2D_avm_constructor_2 = RT_METHOD_FEE_LEVEL_3; // totalCost - 704; //maximum cost of multiple blocks;

    public static final int Result_avm_constructor = RT_METHOD_FEE_LEVEL_1; // totalCost - 146;
    public static final int Result_avm_isSuccess = RT_METHOD_FEE_LEVEL_1; // totalCost - 62;
    public static final int Result_avm_getReturnData = RT_METHOD_FEE_LEVEL_1; // totalCost - 190; // byte code cost - 62; invoked methods cost - 128;
    public static final int Result_avm_hashCode = RT_METHOD_FEE_LEVEL_3;
    public static final int Result_avm_equals = RT_METHOD_FEE_LEVEL_4;
    public static final int Result_avm_toString = RT_METHOD_FEE_LEVEL_4;
    ...
    public static final int Integer_avm_toUnsignedString_1 = RT_METHOD_FEE_LEVEL_3; // totalCost - 576; // byte code cost - 276; invoked methods cost - 300;
    ...
    public static final int Integer_avm_valueOf = RT_METHOD_FEE_LEVEL_1; // totalCost - 182;
    public static final int Integer_avm_valueOf_1 = RT_METHOD_FEE_LEVEL_1; // totalCost - 182;
    public static final int Integer_avm_valueOf_2 = RT_METHOD_FEE_LEVEL_2; // totalCost - 288;
    ...
    public static final int Integer_avm_compare = RT_METHOD_FEE_LEVEL_2; // totalCost - 262; //maximum cost of multiple blocks;
    ...
    public static final int Integer_avm_lowestOneBit = RT_METHOD_FEE_LEVEL_2; // totalCost - 216; // byte code cost - 116; invoked methods cost - 100;
    ...
    public static final int ByteOrder_avm_toString = RT_METHOD_FEE_LEVEL_2; // totalCost - 382; // byte code cost - 282; invoked methods cost - 100;
    public static final int ByteOrder_avm_constructor = RT_METHOD_FEE_LEVEL_1; // totalCost - 131;
    ...
    public static final int Double_avm_valueOf = RT_METHOD_FEE_LEVEL_3; // totalCost - 492;
    public static final int Double_avm_valueOf_1 = RT_METHOD_FEE_LEVEL_3; // totalCost - 432;
    public static final int Double_avm_parseDouble = RT_METHOD_FEE_LEVEL_3; // totalCost - 604; // byte code cost - 176; invoked methods cost - 428;
    public static final int Double_avm_isNaN = RT_METHOD_FEE_LEVEL_1; // totalCost - 161; //maximum cost of multiple blocks;
    public static final int Double_avm_isInfinite = RT_METHOD_FEE_LEVEL_2; // totalCost - 218; //maximum cost of multiple blocks;
    public static final int Double_avm_isFinite = RT_METHOD_FEE_LEVEL_2; // totalCost - 221; //maximum cost of multiple blocks;
    ...
    public static final int Double_avm_hashCode = RT_METHOD_FEE_LEVEL_1; // totalCost - 122;
    ...
    public static final int Double_avm_compareTo = RT_METHOD_FEE_LEVEL_1; // totalCost - 134;
    public static final int Double_avm_compare = RT_METHOD_FEE_LEVEL_2; // totalCost - 222; // byte code cost - 122; invoked methods cost - 100;
    public static final int Double_avm_sum = RT_METHOD_FEE_LEVEL_1; // totalCost - 65;
    public static final int Double_avm_max = RT_METHOD_FEE_LEVEL_1; // totalCost - 122;
    public static final int Double_avm_min = RT_METHOD_FEE_LEVEL_1; // totalCost - 122;
    public static final int Double_avm_equals = RT_METHOD_FEE_LEVEL_2;
    ...
    public static final int Address_avm_constructor = RT_METHOD_FEE_LEVEL_3; // totalCost - 687; //maximum cost of multiple blocks; // byte code cost - 457; invoked methods cost - 230;
    public static final int Address_avm_unwrap = RT_METHOD_FEE_LEVEL_1; // totalCost - 62;
    public static final int Address_avm_hashCode = RT_METHOD_FEE_LEVEL_3; // totalCost - 447; //maximum cost of multiple blocks; // byte code cost - 319; invoked methods cost - 128;
    public static final int Address_avm_equals = RT_METHOD_FEE_LEVEL_4; // totalCost - 1606; //maximum cost of multiple blocks; // byte code cost - 1090; invoked methods cost - 516;
    public static final int Address_avm_toString = RT_METHOD_FEE_LEVEL_4; // totalCost - 1116; // byte code cost - 182; invoked methods cost - 934;
    ...
    public static final int FloatArray2D_avm_clone = RT_METHOD_FEE_LEVEL_3; // totalCost - 762; // byte code cost - 362; invoked methods cost - 400;
    public static final int FloatArray2D_avm_constructor_2 = RT_METHOD_FEE_LEVEL_3; // totalCost - 704; //maximum cost of multiple blocks;
    ...
    public static final int Float_avm_valueOf = RT_METHOD_FEE_LEVEL_3; // totalCost - 420;
    public static final int Float_avm_valueOf_1 = RT_METHOD_FEE_LEVEL_2; // totalCost - 360;
    public static final int Float_avm_parseFloat = RT_METHOD_FEE_LEVEL_3; // totalCost - 604; // byte code cost - 176; invoked methods cost - 428;
    public static final int Float_avm_isNaN = RT_METHOD_FEE_LEVEL_1; // totalCost - 161; //maximum cost of multiple blocks;
    public static final int Float_avm_isInfinite = RT_METHOD_FEE_LEVEL_2; // totalCost - 218; //maximum cost of multiple blocks;
    public static final int Float_avm_isFinite = RT_METHOD_FEE_LEVEL_2; // totalCost - 221; //maximum cost of multiple blocks;
    ...
    public static final int Float_avm_hashCode = RT_METHOD_FEE_LEVEL_1; // totalCost - 122;
    public static final int Float_avm_hashCode_1 = RT_METHOD_FEE_LEVEL_1; // totalCost - 116;
    public static final int Float_avm_equals = RT_METHOD_FEE_LEVEL_2; // totalCost - 343; //maximum cost of multiple blocks;
    ...
    public static final int Float_avm_compareTo = RT_METHOD_FEE_LEVEL_1; // totalCost - 134;
    public static final int Float_avm_compare = RT_METHOD_FEE_LEVEL_2; // totalCost - 222; // byte code cost - 122; invoked methods cost - 100;
    public static final int Float_avm_sum = RT_METHOD_FEE_LEVEL_1; // totalCost - 65;
    public static final int Float_avm_max = RT_METHOD_FEE_LEVEL_1; // totalCost - 122;
    public static final int Float_avm_min = RT_METHOD_FEE_LEVEL_1; // totalCost - 122;
    ...
    public static final int BigDecimal_avm_compareTo = RT_METHOD_FEE_LEVEL_2; // totalCost - 334; // byte code cost - 134; invoked methods cost - 200;
    ...
    public static final int LongArray2D_avm_clone = RT_METHOD_FEE_LEVEL_3; // totalCost - 762; // byte code cost - 362; invoked methods cost - 400;
    public static final int LongArray2D_avm_constructor_2 = RT_METHOD_FEE_LEVEL_3; // totalCost - 704; //maximum cost of multiple blocks;
    ...
    public static final int String_avm_constructor_1 = RT_METHOD_FEE_LEVEL_3; // totalCost - 579; // byte code cost - 351; invoked methods cost - 228;
    public static final int String_avm_constructor_2 = RT_METHOD_FEE_LEVEL_3; // totalCost - 591; // byte code cost - 363; invoked methods cost - 228;
    public static final int String_avm_constructor_3 = RT_METHOD_FEE_LEVEL_3; // totalCost - 591; // byte code cost - 363; invoked methods cost - 228;
    public static final int String_avm_constructor_7 = RT_METHOD_FEE_LEVEL_3; // totalCost - 579; // byte code cost - 351; invoked methods cost - 228;
    public static final int String_avm_constructor_8 = RT_METHOD_FEE_LEVEL_3; // totalCost - 513; // byte code cost - 351; invoked methods cost - 162;
    public static final int String_avm_constructor_9 = RT_METHOD_FEE_LEVEL_3; // totalCost - 513; // byte code cost - 351; invoked methods cost - 162;
    public static final int String_avm_length = RT_METHOD_FEE_LEVEL_2; // totalCost - 288; // byte code cost - 188; invoked methods cost - 100;
    public static final int String_avm_isEmpty = RT_METHOD_FEE_LEVEL_2; // totalCost - 288; // byte code cost - 188; invoked methods cost - 100;
    ...
    public static final int String_avm_getChars = RT_METHOD_FEE_LEVEL_3; // totalCost - 500; // byte code cost - 272; invoked methods cost - 228;
    ...
    public static final int String_avm_equals = RT_METHOD_FEE_LEVEL_3; // totalCost - 483; //maximum cost of multiple blocks; // byte code cost - 383; invoked methods cost - 100;
    public static final int String_avm_contentEquals = RT_METHOD_FEE_LEVEL_3; // totalCost - 416; // byte code cost - 254; invoked methods cost - 162;
    public static final int String_avm_contentEquals_1 = RT_METHOD_FEE_LEVEL_3; // totalCost - 542; // byte code cost - 314; invoked methods cost - 228;
    public static final int String_avm_equalsIgnoreCase = RT_METHOD_FEE_LEVEL_2; // totalCost - 300; // byte code cost - 200; invoked methods cost - 100;
    public static final int String_avm_compareTo = RT_METHOD_FEE_LEVEL_3; // totalCost - 482; // byte code cost - 254; invoked methods cost - 228;
    public static final int String_avm_compareToIgnoreCase = RT_METHOD_FEE_LEVEL_2; // totalCost - 300; // byte code cost - 200; invoked methods cost - 100;
    ...
    public static final int String_avm_hashCode = RT_METHOD_FEE_LEVEL_2; // totalCost - 288; // byte code cost - 188; invoked methods cost - 100;
    ...
    public static final int String_avm_substring = RT_METHOD_FEE_LEVEL_3; // totalCost - 454; // byte code cost - 354; invoked methods cost - 100;
    public static final int String_avm_substring_1 = RT_METHOD_FEE_LEVEL_3; // totalCost - 460; // byte code cost - 360; invoked methods cost - 100;
    public static final int String_avm_subSequence = RT_METHOD_FEE_LEVEL_1; // totalCost - 194;
    public static final int String_avm_concat = RT_METHOD_FEE_LEVEL_3; // totalCost - 526; // byte code cost - 426; invoked methods cost - 100;
    ...
    public static final int String_avm_contains = RT_METHOD_FEE_LEVEL_3; // totalCost - 412; //maximum cost of multiple blocks;
    public static final int String_avm_replaceFirst = RT_METHOD_FEE_LEVEL_3; // totalCost - 604; // byte code cost - 504; invoked methods cost - 100;
    public static final int String_avm_replaceAll = RT_METHOD_FEE_LEVEL_3; // totalCost - 604; // byte code cost - 504; invoked methods cost - 100;
    ...
    public static final int String_avm_trim = RT_METHOD_FEE_LEVEL_3; // totalCost - 448; // byte code cost - 348; invoked methods cost - 100;
    public static final int String_avm_toString = RT_METHOD_FEE_LEVEL_1; // totalCost - 56;
    public static final int String_avm_toCharArray = RT_METHOD_FEE_LEVEL_3; // totalCost - 448; // byte code cost - 348; invoked methods cost - 100;
    ...
    public static final int String_avm_valueOf_1 = RT_METHOD_FEE_LEVEL_3; // totalCost - 630; // byte code cost - 402; invoked methods cost - 228;
    public static final int String_avm_valueOf_2 = RT_METHOD_FEE_LEVEL_3; // totalCost - 642; // byte code cost - 414; invoked methods cost - 228;
    public static final int String_avm_copyValueOf = RT_METHOD_FEE_LEVEL_3; // totalCost - 642; // byte code cost - 414; invoked methods cost - 228;
    public static final int String_avm_copyValueOf_1 = RT_METHOD_FEE_LEVEL_3; // totalCost - 630; // byte code cost - 402; invoked methods cost - 228;
    ...
    public static final int String_avm_valueOf_7 = RT_METHOD_FEE_LEVEL_2; // totalCost - 376; // byte code cost - 276; invoked methods cost - 100;
    public static final int String_avm_valueOf_8 = RT_METHOD_FEE_LEVEL_2; // totalCost - 376; // byte code cost - 276; invoked methods cost - 100;
    ...
    public static final int IntArray2D_avm_clone = RT_METHOD_FEE_LEVEL_3; // totalCost - 762; // byte code cost - 362; invoked methods cost - 400;
    public static final int IntArray2D_avm_constructor_2 = RT_METHOD_FEE_LEVEL_3; // totalCost - 704; //maximum cost of multiple blocks;
    ...
    public static final int BlockchainRuntime_avm_getEnergyPrice = RT_METHOD_FEE_LEVEL_1; // totalCost - 116;
    ...
    public static final int BlockchainRuntime_avm_getBlockPreviousHash = RT_METHOD_FEE_LEVEL_1; // totalCost - 116;
    ...
    public static final int BlockchainRuntime_avm_log_per_topic = 375;
    public static final int BlockchainRuntime_avm_log_per_data_byte= 8;
    ...
    public static final int BlockchainRuntime_avm_println = RT_METHOD_FEE_LEVEL_3; // totalCost - 696; // byte code cost - 122; invoked methods cost - 574;
    ...
    public static final int MathContext_avm_getPrecision = RT_METHOD_FEE_LEVEL_2; // totalCost - 222; // byte code cost - 122; invoked methods cost - 100;
    public static final int MathContext_avm_getRoundingMode = RT_METHOD_FEE_LEVEL_3; // totalCost - 602; // byte code cost - 402; invoked methods cost - 200;
    ...
    public static final int RoundingMode_avm_valueOf = RT_METHOD_FEE_LEVEL_2; // totalCost - 284;
    public static final int RoundingMode_avm_valueOf_1 = RT_METHOD_FEE_LEVEL_3; // totalCost - 656; //maximum cost of multiple blocks; // byte code cost - 396; invoked methods cost - 260;
    ...
    public static final int Boolean_avm_valueOf_1 = RT_METHOD_FEE_LEVEL_2; // totalCost - 212; //maximum cost of multiple blocks;
    public static final int Boolean_avm_toString = RT_METHOD_FEE_LEVEL_1; // totalCost - 472; //maximum cost of multiple blocks;
    public static final int Boolean_avm_toString_1 = RT_METHOD_FEE_LEVEL_1; // totalCost - 478; //maximum cost of multiple blocks;
    ...
    public static final int Boolean_avm_compare = RT_METHOD_FEE_LEVEL_2; // totalCost - 255; //maximum cost of multiple blocks;
    public static final int Boolean_avm_logicalAnd = RT_METHOD_FEE_LEVEL_2; // totalCost - 200; //maximum cost of multiple blocks;
    public static final int Boolean_avm_logicalOr = RT_METHOD_FEE_LEVEL_2; // totalCost - 200; //maximum cost of multiple blocks;
    ...
    public static final int CharArray2D_avm_clone = RT_METHOD_FEE_LEVEL_3; // totalCost - 762; // byte code cost - 362; invoked methods cost - 400;
    public static final int CharArray2D_avm_constructor_2 = RT_METHOD_FEE_LEVEL_3; // totalCost - 704; //maximum cost of multiple blocks;

    public static final int Character_avm_valueOf = RT_METHOD_FEE_LEVEL_3; // totalCost - 534;
    ...
    public static final int StringBuilder_avm_constructor_1 = RT_METHOD_FEE_LEVEL_3; // totalCost - 579; // byte code cost - 351; invoked methods cost - 228;
    ...
    public static final int StringBuilder_avm_append = RT_METHOD_FEE_LEVEL_2; // totalCost - 236; // byte code cost - 136; invoked methods cost - 100;
    public static final int StringBuilder_avm_append_1 = RT_METHOD_FEE_LEVEL_3; // totalCost - 424; // byte code cost - 196; invoked methods cost - 228;
    ...
    public static final int StringBuilder_avm_append_3 = RT_METHOD_FEE_LEVEL_3; // totalCost - 424; // byte code cost - 196; invoked methods cost - 228;
    public static final int StringBuilder_avm_append_4 = RT_METHOD_FEE_LEVEL_3; // totalCost - 436; // byte code cost - 208; invoked methods cost - 228;
    ...
    public static final int StringBuilder_avm_append_6 = RT_METHOD_FEE_LEVEL_3; // totalCost - 496; // byte code cost - 268; invoked methods cost - 228;
    ...
    public static final int StringBuilder_avm_replace = RT_METHOD_FEE_LEVEL_3; // totalCost - 443; // byte code cost - 215; invoked methods cost - 228;
    public static final int StringBuilder_avm_insert = RT_METHOD_FEE_LEVEL_3; // totalCost - 442; // byte code cost - 214; invoked methods cost - 228;
    public static final int StringBuilder_avm_insert_1 = RT_METHOD_FEE_LEVEL_2; // totalCost - 242; // byte code cost - 142; invoked methods cost - 100;
    public static final int StringBuilder_avm_insert_2 = RT_METHOD_FEE_LEVEL_3; // totalCost - 430; // byte code cost - 202; invoked methods cost - 228;
    public static final int StringBuilder_avm_insert_3 = RT_METHOD_FEE_LEVEL_3; // totalCost - 430; // byte code cost - 202; invoked methods cost - 228;
    public static final int StringBuilder_avm_insert_4 = RT_METHOD_FEE_LEVEL_3; // totalCost - 490; // byte code cost - 262; invoked methods cost - 228;
    public static final int StringBuilder_avm_insert_5 = RT_METHOD_FEE_LEVEL_3; // totalCost - 562; // byte code cost - 334; invoked methods cost - 228;
    ...
    public static final int StringBuilder_avm_indexOf = RT_METHOD_FEE_LEVEL_3; // totalCost - 416; // byte code cost - 188; invoked methods cost - 228;
    public static final int StringBuilder_avm_indexOf_1 = RT_METHOD_FEE_LEVEL_3; // totalCost - 422; // byte code cost - 194; invoked methods cost - 228;
    public static final int StringBuilder_avm_lastIndexOf = RT_METHOD_FEE_LEVEL_3; // totalCost - 416; // byte code cost - 188; invoked methods cost - 228;
    public static final int StringBuilder_avm_lastIndexOf_1 = RT_METHOD_FEE_LEVEL_3; // totalCost - 422; // byte code cost - 194; invoked methods cost - 228;
    ...
    public static final int StringBuilder_avm_subSequence = RT_METHOD_FEE_LEVEL_1; // totalCost - 188;
    public static final int StringBuilder_avm_length = RT_METHOD_FEE_LEVEL_1; // totalCost - 176;

    public static final int System_avm_arraycopy = RT_METHOD_FEE_LEVEL_4; // totalCost - 819; //maximum cost of multiple blocks; // byte code cost - 619; invoked methods cost - 200;
    ...
    public static final int StringBuffer_avm_constructor_1 = RT_METHOD_FEE_LEVEL_3; // totalCost - 579; // byte code cost - 351; invoked methods cost - 228;
    public static final int StringBuffer_avm_constructor_2 = RT_METHOD_FEE_LEVEL_2; // totalCost - 265;
    public static final int StringBuffer_avm_length = RT_METHOD_FEE_LEVEL_2; // totalCost - 222; // byte code cost - 122; invoked methods cost - 100;
    ...
    public static final int StringBuffer_avm_append = RT_METHOD_FEE_LEVEL_2; // totalCost - 243; // byte code cost - 143; invoked methods cost - 100;
    ...
    public static final int StringBuffer_avm_append_4 = RT_METHOD_FEE_LEVEL_3; // totalCost - 503; // byte code cost - 275; invoked methods cost - 228;
    public static final int StringBuffer_avm_append_5 = RT_METHOD_FEE_LEVEL_3; // totalCost - 431; // byte code cost - 203; invoked methods cost - 228;
    public static final int StringBuffer_avm_append_6 = RT_METHOD_FEE_LEVEL_3; // totalCost - 443; // byte code cost - 215; invoked methods cost - 228;
    ...
    public static final int StringBuffer_avm_replace = RT_METHOD_FEE_LEVEL_3; // totalCost - 443; // byte code cost - 215; invoked methods cost - 228;
    ...
    public static final int StringBuffer_avm_subSequence = RT_METHOD_FEE_LEVEL_3; // totalCost - 554; // byte code cost - 354; invoked methods cost - 200;
    ...
    public static final int StringBuffer_avm_insert = RT_METHOD_FEE_LEVEL_3; // totalCost - 442; // byte code cost - 214; invoked methods cost - 228;
    public static final int StringBuffer_avm_insert_1 = RT_METHOD_FEE_LEVEL_2; // totalCost - 242; // byte code cost - 142; invoked methods cost - 100;
    public static final int StringBuffer_avm_insert_2 = RT_METHOD_FEE_LEVEL_3; // totalCost - 430; // byte code cost - 202; invoked methods cost - 228;
    public static final int StringBuffer_avm_insert_3 = RT_METHOD_FEE_LEVEL_3; // totalCost - 430; // byte code cost - 202; invoked methods cost - 228;
    ...
    public static final int StringBuffer_avm_indexOf = RT_METHOD_FEE_LEVEL_3; // totalCost - 416; // byte code cost - 188; invoked methods cost - 228;
    public static final int StringBuffer_avm_indexOf_1 = RT_METHOD_FEE_LEVEL_3; // totalCost - 422; // byte code cost - 194; invoked methods cost - 228;
    public static final int StringBuffer_avm_lastIndexOf = RT_METHOD_FEE_LEVEL_3; // totalCost - 416; // byte code cost - 188; invoked methods cost - 228;
    public static final int StringBuffer_avm_lastIndexOf_1 = RT_METHOD_FEE_LEVEL_3; // totalCost - 422; // byte code cost - 194; invoked methods cost - 228;
    ...
    public static final int Arrays_avm_hashCode = RT_METHOD_FEE_LEVEL_3; // totalCost - 508; //maximum cost of multiple blocks; // byte code cost - 280; invoked methods cost - 228;
    public static final int Arrays_avm_equals = RT_METHOD_FEE_LEVEL_4; // totalCost - 861; //maximum cost of multiple blocks; // byte code cost - 505; invoked methods cost - 356;
    public static final int Arrays_avm_copyOfRange = RT_METHOD_FEE_LEVEL_3; // totalCost - 576; // byte code cost - 348; invoked methods cost - 228;
    public static final int Arrays_avm_fill = RT_METHOD_FEE_LEVEL_3; // totalCost - 422; // byte code cost - 194; invoked methods cost - 228;
    ...
    public static final int StrictMath_avm_toRadians = RT_METHOD_FEE_LEVEL_2; // totalCost - 216; // byte code cost - 116; invoked methods cost - 100;
    public static final int StrictMath_avm_toDegrees = RT_METHOD_FEE_LEVEL_2; // totalCost - 216; // byte code cost - 116; invoked methods cost - 100;
    ...
    public static final int StrictMath_avm_signum = RT_METHOD_FEE_LEVEL_1; // totalCost - 116;
    public static final int StrictMath_avm_signum_1 = RT_METHOD_FEE_LEVEL_1; // totalCost - 116;
    ...
    public static final int StrictMath_avm_getExponent = RT_METHOD_FEE_LEVEL_1; // totalCost - 116;
    public static final int StrictMath_avm_getExponent_1 = RT_METHOD_FEE_LEVEL_1; // totalCost - 116;
    public static final int StrictMath_avm_nextAfter = RT_METHOD_FEE_LEVEL_1; // totalCost - 122;
    public static final int StrictMath_avm_nextAfter_1 = RT_METHOD_FEE_LEVEL_1; // totalCost - 122;
    public static final int StrictMath_avm_nextUp = RT_METHOD_FEE_LEVEL_1; // totalCost - 116;
    public static final int StrictMath_avm_nextUp_1 = RT_METHOD_FEE_LEVEL_1; // totalCost - 116;
    public static final int StrictMath_avm_nextDown = RT_METHOD_FEE_LEVEL_1; // totalCost - 116;
    public static final int StrictMath_avm_nextDown_1 = RT_METHOD_FEE_LEVEL_1; // totalCost - 116;
    ...
    public static final int Enum_avm_constructor = RT_METHOD_FEE_LEVEL_1; // totalCost - 146;
    public static final int Enum_avm_toString = RT_METHOD_FEE_LEVEL_1; // totalCost - 128;
    public static final int Enum_avm_equals = RT_METHOD_FEE_LEVEL_2; // totalCost - 225; //maximum cost of multiple blocks;
    public static final int Enum_avm_clone = RT_METHOD_FEE_LEVEL_2; // totalCost - 263; // byte code cost - 163; invoked methods cost - 100;
    public static final int Enum_avm_valueOf = 3516; // totalCost - 3516; //maximum cost of multiple blocks; // byte code cost - 753; invoked methods cost - 2763;

    public static final int Byte_avm_toString = RT_METHOD_FEE_LEVEL_1; // totalCost - 122;
    public static final int Byte_avm_valueOf = RT_METHOD_FEE_LEVEL_2; // totalCost - 270;
    ...
    public static final int Byte_avm_parseByte_1 = RT_METHOD_FEE_LEVEL_1; // totalCost - 122;
    public static final int Byte_avm_valueOf_1 = RT_METHOD_FEE_LEVEL_1; // totalCost - 182;
    public static final int Byte_avm_valueOf_2 = RT_METHOD_FEE_LEVEL_1; // totalCost - 122;
    ...
    public static final int Byte_avm_toString_1 = RT_METHOD_FEE_LEVEL_1; // totalCost - 122;
    ...
    public static final int Long_avm_toString = RT_METHOD_FEE_LEVEL_3; // totalCost - 582; // byte code cost - 282; invoked methods cost - 300;
    ...
    public static final int Long_avm_valueOf = RT_METHOD_FEE_LEVEL_1; // totalCost - 182;
    public static final int Long_avm_valueOf_1 = RT_METHOD_FEE_LEVEL_1; // totalCost - 182;
    public static final int Long_avm_valueOf_2 = RT_METHOD_FEE_LEVEL_2; // totalCost - 312;
    ...
    public static final int Long_avm_compare = RT_METHOD_FEE_LEVEL_2; // totalCost - 266; //maximum cost of multiple blocks;
    ...
    public static final int Long_avm_numberOfLeadingZeros = RT_METHOD_FEE_LEVEL_3; // totalCost - 416; // byte code cost - 116; invoked methods cost - 300;
    public static final int Long_avm_numberOfTrailingZeros = RT_METHOD_FEE_LEVEL_3; // totalCost - 416; // byte code cost - 116; invoked methods cost - 300;
    ...
    public static final int Short_avm_toString = RT_METHOD_FEE_LEVEL_1; // totalCost - 122;
    ...
    public static final int Short_avm_parseShort_1 = RT_METHOD_FEE_LEVEL_1; // totalCost - 122;
    public static final int Short_avm_valueOf = RT_METHOD_FEE_LEVEL_1; // totalCost - 182;
    public static final int Short_avm_valueOf_1 = RT_METHOD_FEE_LEVEL_1; // totalCost - 122;
    public static final int Short_avm_valueOf_2 = RT_METHOD_FEE_LEVEL_2; // totalCost - 276;
    ...
    public static final int Short_avm_toString_1 = RT_METHOD_FEE_LEVEL_1; // totalCost - 122;
    ...
    public static final int Short_avm_reverseBytes = RT_METHOD_FEE_LEVEL_2; // totalCost - 416; // byte code cost - 116; invoked methods cost - 300;
    ...
    public static final int TimeUnit_avm_valueOf = RT_METHOD_FEE_LEVEL_2;
